...
// parallelism: mpi and multithreading handling
#include <deal.II/base/mpi.h>
#include <deal.II/base/work_stream.h>

// convergence table creation
#include <deal.II/base/parsed_convergence_table.h>

// quadrature handling: needed for QGauss
#include <deal.II/base/quadrature_lib.h>

// timing
#include <deal.II/base/timer.h>

// various, space filling curve functions
#include <deal.II/base/utilities.h>

// mesh handling (triangulation and refinement) in distributed fashion
...
// finite elements handling
#include <deal.II/fe/fe_q.h>
#include <deal.II/fe/fe_values.h>

// mesh creation classes and iterators
...
// some linear algebra classes (needed for parallel)
...
// helper for parallelisation of loop
#include <deal.II/meshworker/copy_data.h>
#include <deal.II/meshworker/scratch_data.h>

// error estimation and other tools
...
// renaming for namespace dealii::LinearAlgebraTrilinos for parallel linear algebra
namespace LA
{
...
// main class, templated on dimension of the problem
template <int dim>
class Step3
{
public:
  // constructor
  Step3();
  // function to be called in main to run the problem
  void
...
private:
  ...
  // error estimation (with Kelly estimator)
  void
  estimate_error();
  // function for deciding at each step which part of triangulation needs refinement
  void
  mark_cells_for_refinement();
  // function refining grid
  void
  refine_grid();
  // function to initialise system
  void
  setup_system();
  // function to
  void
...
Step3<dim>::mark_cells_for_refinement()
{
  parallel::distributed::GridRefinement::refine_and_coarsen_fixed_fraction(
    triangulation, error_estimator, 0.33, 0.0);
}
...
Step3<dim>::compute_error()
{
  ...
  pout << "L2 norm of error: " << L2_error_per_cell.l2_norm() << std::endl;
  pout << "H1 norm of error: " << H1_error_per_cell.l2_norm() << std::endl;
}
...
{
  // The -1 at the end tells TBB how many maximum threads to spawn: -1 = same
  // number of cpus.
